                ...
                <div className="modal-dialog">
                    ...
                    <div>
                        <div className="modal-body">
                            <p>You have been invited to a match of Pong by <strong>{props.senderUsername}</strong>. Do you accept?</p>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-clear" onClick={handleClickYes}>Yes</button>
